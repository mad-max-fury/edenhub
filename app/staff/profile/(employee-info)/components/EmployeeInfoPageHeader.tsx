...
export const EmployeeInfoPageHeader = ({
  ...
  const CRUMBS = [
    ...
    {
      name: data?.employeeBioData.basicInformation?.fullname ?? "",
      path: AuthRouteConfig.PROFILE,
    },
  ];
    ...
    <>
      ...
      <div className="ml-auto mt-6 flex w-full max-w-[1056px] flex-col items-start md:flex-row md:items-center md:gap-4">
        ...
        <div className="mt-4 w-full flex-1 flex-grow text-center md:mt-0 md:text-left">
                  ...
                  buttonGroup={[
                    {
                      ...
                      onClick: () => {
                        if (
                          ...
                          dispatch(
                            setBioDataEmployeeId(
                              data?.employeeBioData?.basicInformation
                                ?.employeeId,
                            ),
                          );
                        }
                        return push(`${AuthRouteConfig.PROFILE}/edit-profile`);
                      },
                    },
                  ]}
                />
          ...
          <div className="mt-4 flex flex-row flex-wrap items-center gap-3 sm:mt-0">
