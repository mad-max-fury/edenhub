  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "h-xxl": ["3rem", { lineHeight: "48px" }],
        "h-xl": ["2rem", { lineHeight: "40px" }],
        "h-l": ["1.5rem", { lineHeight: "24px" }],
        "h-m": ["1.1875rem", { lineHeight: "24px" }],
        "h-s": ["1rem", { lineHeight: "24px" }],
        "h-xs": [".75rem", { lineHeight: "15.96px" }],

        // Paragraph element styles
        "p-xxl": ["1.5rem", { lineHeight: "32px" }],
        "p-xl": ["1.1875rem", { lineHeight: "28px" }],
        "p-l": ["1rem", { lineHeight: "16px" }],
        "p-m": ["0.875rem", { lineHeight: "20.02px" }],
        "p-s": ["0.75rem", { lineHeight: "15.96px" }],
        // Controls element styles
        "c-xxl": ["1.5rem", { lineHeight: "24px" }],
        "c-xl": ["1.1875rem", { lineHeight: "19px" }],
        "c-l": ["1rem", { lineHeight: "24px" }],
        "c-m": ["0.875rem", { lineHeight: "15.96px" }],
        "c-s": ["0.75rem", { lineHeight: "12px" }],
      },
      colors: {
