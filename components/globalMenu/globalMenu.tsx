...
export const GlobalMenu = () => {
  ...
  return (
    <>
      <nav
        className={cn(
          "sticky left-0 right-0 top-0 isolate z-30 flex h-[clamp(64px,_4vw,_72px)] items-center justify-between px-[clamp(12px,_3vw,_24px)] transition-colors duration-300 ease-in-out",
